			...
			<script type="text/javascript">				
  			  var url = 'page/barang/pdfbook.php';
			</script>
			...
			<image src="../img/print.png" onclick="return popitup('PrintBook.php?kertas=page/barang/pdfbook.php')" title="print" style="width:30px;height:30px;">
			<image src="../img/download.png" onclick="window.open('page/barang/pdfbook.php','_blank');" title="download" style="width:30px;height:30px;">
			</div>
