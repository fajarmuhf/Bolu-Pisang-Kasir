			...
			<?php
				...
				if($exquery){
					...
					echo "<h1 class='title'>Data - Data Pemasukan</h1>";
					...
					echo "<ul>";
					echo "<li  style=\"width:40%;background-color:#443AD8;border-radius:30px;\" class=\"geser\"><a href=\"?page=penjualan&i=input2\">+ Pemasukan</a></li>";
					echo "</ul>";
			...
			<script>
				...
				function loadMore(start,key){
					if(lagiloading==false){
						lagiloading=true;
					jQuery.ajax({
						url:'kasir/page/<?php echo $namapage;?>/get4.php',
