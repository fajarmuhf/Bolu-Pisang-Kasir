			<?php
				...
				if($exquery){
					...
					echo "<input type=text placeholder='scan barcode disini...' name='pencarian' class='pencarian' id='pencarian' autofocus>";
			...
			<script>
				...
				function search(){
					...
					jQuery('#tabelku').html('<tr><td>Nama</td><td>Gambar</td><td>Jumlah</td><td>Harga</td><td>Total Bayar</td><td>Aksi</td></tr>');
