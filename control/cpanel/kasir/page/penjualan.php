<div id="sidebar">
	<ul>
		<li class="geser"><a href="?page=penjualan">Keranjang</a></li>
		<li class="geser"><a href="?page=penjualan&i=history">Penjualan</a></li>
		<li class="geser"><a href="?page=penjualan&i=pengiriman">Pemasukan</a></li>
		<li class="geser"><a href="?page=penjualan&i=retur">Retur / Kirim</a></li>
	</ul>
</div>
<div id="content">
	<?php
		...
		else if(@$_GET["i"] == "input3"){
			include "penjualan/input3.php";
		}
		else if(@$_GET["i"] == "edit"){
		...
		else if(@$_GET["i"] == "retur"){
			include "penjualan/retur.php";
		}
