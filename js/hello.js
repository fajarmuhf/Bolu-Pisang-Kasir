//
    ...
    function renderPage(canvas,num) {
      ...
      document.getElementById('number-pages').textContent = pdfDoc.numPages;
      $('#magazine').turn('pages', pdfDoc.numPages);
    }
    ...
    tuangcanvas(document.getElementById('the-canvas1'),1,url);
