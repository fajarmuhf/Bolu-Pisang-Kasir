			...
			<script type="text/javascript">				
  			  var url = 'page/mentah/pdfbook.php';
			</script>
			...
			<image src="../img/print.png" onclick="return popitup('PrintBook.php?kertas=page/mentah/pdfbook.php')" title="print" style="width:30px;height:30px;">
			<image src="../img/download.png" onclick="window.open('page/mentah/pdfbook.php','_blank');" title="download" style="width:30px;height:30px;">
			</div>
