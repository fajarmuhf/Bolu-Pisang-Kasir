			...
			<script type="text/javascript">				
  			  var url = 'page/pengeluaran/pdfbook.php?tglbefore=<?php echo str_replace(':','/',($_SESSION['tglbefore']));?>&tglafter=<?php echo str_replace(':','/',($_SESSION['tglafter']));?>';
			</script>
			...
			<image src="../img/print.png" onclick="return popitup('PrintBook.php?kertas=page/pengeluaran/pdfbook.php&tglbefore=<?php echo str_replace(':','/',($_SESSION['tglbefore']));?>&tglafter=<?php echo str_replace(':','/',($_SESSION['tglafter']));?>')" title="print" style="width:30px;height:30px;">
			<image src="../img/download.png" onclick="window.open('page/pengeluaran/pdfbook.php?tglbefore=<?php echo str_replace(':','/',($_SESSION['tglbefore']));?>&tglafter=<?php echo str_replace(':','/',($_SESSION['tglafter']));?>','_blank');" title="download" style="width:30px;height:30px;">
			</div>
