			...
			<script type="text/javascript">				
  			  var url = 'page/pengiriman/pdfbook.php';
			</script>
			...
			<image src="../img/print.png" onclick="return popitup('PrintBook.php?kertas=page/pengiriman/pdfbook.php')" title="print" style="width:30px;height:30px;">
			<image src="../img/download.png" onclick="window.open('page/pengiriman/pdfbook.php','_blank');" title="download" style="width:30px;height:30px;">
			</div>
