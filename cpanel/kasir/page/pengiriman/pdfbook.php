<?php
	...
	$fpdf->SetY(70);
	$fpdf->Cell(55,20,'Daftar Data Pengiriman');
	//menset awal X dan Y
	$fpdf->SetFont('Courier','B',12);
	
	$fpdf->SetY(150);
	$header = array('Id', 'Id User','Id Target','Id Barang','Jumlah','Status');
	// Data loading
	$Koneksi = new Hubungi();
	$Koneksi->Konek("bolu_pisang");
	
	$query = "SELECT * FROM Pengiriman WHERE 1";
